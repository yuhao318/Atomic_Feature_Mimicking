...
class AutoInt_TTD(BaseModel_TTD):
    ...
    def __init__(self, linear_feature_columns, dnn_feature_columns, ttd_feature_columns, att_layer_num=3,
        ...
        super(AutoInt_TTD, self).__init__(linear_feature_columns, dnn_feature_columns, ttd_feature_columns, l2_reg_linear=0,
