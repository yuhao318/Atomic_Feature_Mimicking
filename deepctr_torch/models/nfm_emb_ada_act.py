...
from ..layers import DNN, BiInteractionPooling, DNN_Ada_Act


class NFM_EMB_Ada_Act(BaseModel):
    ...
    def __init__(self,
                 linear_feature_columns, dnn_feature_columns, num_sparse_features,  emb_input_dims, emb_output_dims, 
                 tags = None, dims = None, dnn_hidden_units=(128, 128),
        ...
        super(NFM_EMB_Ada_Act, self).__init__(linear_feature_columns, dnn_feature_columns, l2_reg_linear=l2_reg_linear,
                                  l2_reg_embedding=l2_reg_embedding, init_std=init_std, seed=seed, task=task,
                                  device=device, gpus=gpus)

        self.dnn = DNN_Ada_Act(self.compute_input_dim(dnn_feature_columns, include_sparse=False) + emb_output_dims,
                       dnn_hidden_units, tags = tags, dims = dims, 
