...
class DCN_EMB(BaseModel):
    ...
    def __init__(self, linear_feature_columns, dnn_feature_columns, num_sparse_features, emb_input_dims, emb_output_dims, cross_num=2, cross_parameterization='vector',
        ...
        super(DCN_EMB, self).__init__(linear_feature_columns=linear_feature_columns,
