...
class NFM_TTD(BaseModel_TTD):
    ...
    def __init__(self,
                 linear_feature_columns, dnn_feature_columns, ttd_feature_columns, dnn_hidden_units=(128, 128),
        ...
        super(NFM_TTD, self).__init__(linear_feature_columns, dnn_feature_columns, ttd_feature_columns, l2_reg_linear=l2_reg_linear,
