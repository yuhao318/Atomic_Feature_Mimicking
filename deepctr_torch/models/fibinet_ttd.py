...
from .basemodel_ttd import BaseModel_TTD
...
class FiBiNET_TTD(BaseModel_TTD):
    ...
    def __init__(self, linear_feature_columns, dnn_feature_columns, ttd_feature_columns, bilinear_type='interaction',
                 reduction_ratio=3, dnn_hidden_units=(128, 128), l2_reg_linear=1e-5,
                 l2_reg_embedding=1e-5, l2_reg_dnn=0, init_std=0.0001, seed=1024, dnn_dropout=0, dnn_activation='relu',
                 task='binary', device='cpu', gpus=None):
        super(FiBiNET_TTD, self).__init__(linear_feature_columns, dnn_feature_columns, ttd_feature_columns, l2_reg_linear=l2_reg_linear,
    ...
    def forward(self, X):
        sparse_embedding_list, dense_value_list = self.input_from_feature_columns(X, self.dnn_feature_columns,
                                                                                  self.embedding_dict, self.ttd_feature_columns)
