...
from ..layers import DNN, concat_fun, InteractingLayer, DNN_Ada_Act


class AutoInt_EMB_Ada_Act(BaseModel):
    ...
    def __init__(self, linear_feature_columns, dnn_feature_columns, num_sparse_features, emb_input_dims, emb_output_dims, 
        ...
        super(AutoInt_EMB_Ada_Act, self).__init__(linear_feature_columns, dnn_feature_columns, l2_reg_linear=0,
