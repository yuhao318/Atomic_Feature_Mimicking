...
class DCN_TTD(BaseModel_TTD):
    ...
    def __init__(self, linear_feature_columns, dnn_feature_columns, ttd_feature_columns, cross_num=2, cross_parameterization='vector',
        ...
        super(DCN_TTD, self).__init__(linear_feature_columns=linear_feature_columns,
                                  dnn_feature_columns=dnn_feature_columns, ttd_feature_columns= ttd_feature_columns, l2_reg_embedding=l2_reg_embedding,
