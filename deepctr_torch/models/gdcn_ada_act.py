...
class GDCN_Ada_Act(BaseModel):
    ...
    def __init__(self, linear_feature_columns, dnn_feature_columns, tags = None, dims = None, cross_num=2, cross_parameterization='vector',
        ...
        super(GDCN_Ada_Act, self).__init__(linear_feature_columns=linear_feature_columns,
        ...
        self.dnn_linear = nn.Linear(dnn_linear_in_feature, 1, bias=False).to(
            device)
        self.crossnet = CrossNet(input_dim=self.compute_input_dim(dnn_feature_columns),
