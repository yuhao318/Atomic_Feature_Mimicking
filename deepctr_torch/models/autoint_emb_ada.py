...
from ..layers import DNN, concat_fun, InteractingLayer, DNN_Ada


class AutoInt_EMB_Ada(BaseModel):
    ...
    def __init__(self, linear_feature_columns, dnn_feature_columns, num_sparse_features, emb_input_dims, emb_output_dims, 
                 tags = None, dims = None, att_layer_num=3,
        ...
        super(AutoInt_EMB_Ada, self).__init__(linear_feature_columns, dnn_feature_columns, l2_reg_linear=0,
        ...
        embedding_size = emb_output_dims
    ...
    def forward(self, X):
        ...
        att_input = torch.einsum("ijk,jkl->ijl", (att_input, self.emb_weight)) + self.emb_bias
