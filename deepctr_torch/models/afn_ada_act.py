...
from ..layers import LogTransformLayer, DNN, DNN_Ada_Act


class AFN_Ada_Act(BaseModel):
    ...
    def __init__(self,
                 linear_feature_columns, dnn_feature_columns, tags = None, dims = None,
        ...
        super(AFN_Ada_Act, self).__init__(linear_feature_columns, dnn_feature_columns, l2_reg_linear=l2_reg_linear,
                                  l2_reg_embedding=l2_reg_embedding, init_std=init_std, seed=seed, task=task,
                                  device=device, gpus=gpus)

        self.ltl = LogTransformLayer(len(self.embedding_dict), self.embedding_size, ltl_hidden_size)
        self.afn_dnn = DNN_Ada_Act(self.embedding_size * ltl_hidden_size, afn_dnn_hidden_units, tags = tags, dims = dims,
