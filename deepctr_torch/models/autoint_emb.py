...
class AutoInt_EMB(BaseModel):
    ...
    def __init__(self, linear_feature_columns, dnn_feature_columns, num_sparse_features, emb_input_dims, emb_output_dims, att_layer_num=3,
        ...
        super(AutoInt_EMB, self).__init__(linear_feature_columns, dnn_feature_columns, l2_reg_linear=0,
