...
class AutoInt_Ada(BaseModel):
    ...
    def __init__(self, linear_feature_columns, dnn_feature_columns, tags = None, dims = None, att_layer_num=3,
        ...
        super(AutoInt_Ada, self).__init__(linear_feature_columns, dnn_feature_columns, l2_reg_linear=0,
