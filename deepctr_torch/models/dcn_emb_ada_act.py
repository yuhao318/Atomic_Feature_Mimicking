...
from ..layers import CrossNet, DNN, DNN_Ada_Act


class DCN_EMB_Ada_Act(BaseModel):
    ...
    def __init__(self, linear_feature_columns, dnn_feature_columns, num_sparse_features, emb_input_dims, emb_output_dims, 
        ...
        super(DCN_EMB_Ada_Act, self).__init__(linear_feature_columns=linear_feature_columns,
